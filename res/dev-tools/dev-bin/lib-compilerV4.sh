...
# DO NOT DELETE THE DATA BELOW! THEY ARE USED BY FUNCTIONS IN THE MODULE INITIALIZATION SCRIPT THAT MANAGE INFORMATION ABOUT COMPILED FILES!

# This file was generated by the "lib-compilerV4.sh" file.
