...
source "$__BASH_UTILS_CONF_FILE_TEXT" # || { echo "Fail text.conf"; exit 1; }
source "$__BASH_UTILS_CONF_FILE_COLORS" || { echo "Fail colors.conf"; exit 1; }
...
function D_Array()
{
	...
	echo "$p_string$p_newcolor$__BU_TXT_RESET"
}
