...
# Name          : Packages.sh
# Module        : Software
# Description   : Installation of a specific package according to the package manager (in case the software's package name is not the same on multiple platforms).
