...
\begin{itemize}
    \item \textbf{\color{lime}basis\color{white} :} les fonctions les plus basiques (affichage de texte coloré, vérifications, gestion\linebreak de couleurs, saisies de l'utilisateur).\\[1\baselineskip]
\end{itemize}
