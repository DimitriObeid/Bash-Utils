...
\begin{itemize}
    ...
    \item \textbf{Astuce :} Vous pouvez vous y rendre directement via le lien symbolique \textbf{\color{lime}bin} dans le dossier racine de la librairie. \textbf{Attention :} Pour ceux qui utilisent WSL, ce lien ne marche pas sur les explorateurs de fichiers sur Windows.\\[1\baselineskip]
\end{itemize}
