...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}lib-generator.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "lib-generator.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "lib-generator.sh")
  /Keywords ()
}
