...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}module-add-file-by-OS.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "module-add-file-by-OS.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "module-add-file-by-OS.sh")
  /Keywords ()
}
