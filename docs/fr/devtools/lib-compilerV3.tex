...
\title{\color{sec1}Fonctionnement du compilateur du framework Bash Utils}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du compilateur du framework Bash Utils)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du compilateur du framework Bash Utils)
  /Keywords ()
}
