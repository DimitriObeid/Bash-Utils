...
\title{\color{red}Code \color{orange}couleur \color{yellow}de \color{green}la \color{blue}documentation \\\color{violet}officielle \color{red}du \color{orange}framework \color{yellow}Bash \color{green}Utils}\color{text}
