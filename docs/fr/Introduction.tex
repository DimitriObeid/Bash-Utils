...
\begin{justify}
    Bash Utils est divisé en deux parties : la librairie, et les modules, expliqués plus en détails dans le fichier \textbf{\color{lime}modules/Fonctionnement.pdf\color{white}}.
\end{justify}
...
\begin{justify}
    ...
    \begin{itemize}
        \item \color{orange}\textbf{\$HOME\color{lime}/.Bash-utils-init.sh\color{white}}\color{white}
    \end{itemize}
\end{justify}
...
\begin{justify}
    Ce lien symbolique pointe vers le dossier \textbf{\color{lime}res/dev-tools/dev-bin\color{white}}.
\end{justify}
