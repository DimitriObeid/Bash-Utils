...
\title{\color{sec1}Variables et fonctions du fichier \\de configuration du module \\principal \color{path}Filesystem.conf}\color{text}
\author{Dimitri OBEID}
\date{2022}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Variables et fonctions du fichier de configuration du module principal "Filesystem.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Variables et fonctions du fichier de configuration du module principal "Filesystem.conf")
  /Keywords ()
}
