...
\pdfinfo{
  /Title    (Fonctions et variables du fichier de configuration du module principal "Text.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du fichier de configuration du module principal "Text.conf")
  /Keywords ()
}
