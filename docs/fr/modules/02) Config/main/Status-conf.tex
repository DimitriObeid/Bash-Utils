...
\pdfinfo{
  /Title    (Variables et fonctions du fichier de configuration du module principal "Status.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Variables et fonctions du fichier de configuration du module principal "Status.conf")
  /Keywords ()
}
