...
\definecolor{back}{HTML}{000000} % Blanc  - Couleur de fond du document.
\definecolor{case}{HTML}{fcff00} %        - Couleur des conditions "case".
\definecolor{cmds}{HTML}{909090} %        - Couleur des noms de commandes du système et de leurs arguments.
\definecolor{cond}{HTML}{be480a} %        - Couleur des conditions "if".
\definecolor{func}{HTML}{800080} %        - Couleur des fonctions définies dans chaque module du framework Bash Utils.

\definecolor{loop}{HTML}{00ffff} %        - Couleur des boucles.
\definecolor{main}{HTML}{8F00FF} %        - Couleur des fonctions du script principal.
\definecolor{path}{HTML}{bfff00} % vert   - Couleur des chemins de dossiers et de fichiers.
\definecolor{sec1}{HTML}{ff0000} %        - Couleur des titres principaux et de premier niveau.
\definecolor{sec2}{HTML}{00ff00} %        - Couleur des titres de deuxième niveau.

\definecolor{sec3}{HTML}{0060ff} %        - Couleur des titres de troisième niveau.
\definecolor{text}{HTML}{ffffff} %| Noir  - Couleur du texte normal.
\definecolor{vars}{HTML}{FF7F00} %        - Couleur des noms des paramètres et des variables.
...
\title{\color{sec1}Fonctions et variables du fichier \\de configuration du module \\principal \color{path}Time.conf}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du fichier de configuration du module principal "Time.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du fichier de configuration du module principal "Time.conf")
  /Keywords ()
}
