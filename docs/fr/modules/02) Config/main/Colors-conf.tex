...
\color{sec3}
\subsubsection{BU.Main.Colors.SetBGColor}\color{text}

\begin{justify}
    \textbf{Fonction : \color{func}BU.Main.Colors.SetBGColor}
\end{justify}
...
\color{sec3}
\subsubsection{BU.Main.Colors.SetTextColor}\color{text}

\begin{justify}
    \textbf{Fonction : \color{func}BU.Main.Colors.SetTextColor}
\end{justify}
...
\begin{justify}
    ...
    La fonction fonctionne de la même manière que la fonction \textbf{\color{func}BU.Main.Colors.SetBGColor}, à quelques différences près :
    \begin{enumerate}
...
\begin{justify}
    Chacune des variables variables globales de couleur commençant par ce nom retourne le résultat de la fonction \textbf{\color{func}BU.Main.Colors.SetTextColor} lors de l'appel d'une de ces variables, pour colorer le texte selon le code couleur.
\end{justify}
...
\begin{justify}
    Chacune des variables variables globales de couleur commençant par ce nom retourne le résultat de la fonction \textbf{\color{func}BU.Main.Colors.SetBGColor} lors de l'appel d'une de ces variables, pour colorer le texte selon le code couleur.
\end{justify}
