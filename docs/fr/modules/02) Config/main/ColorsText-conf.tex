...
\title{\color{sec1}Fonctions et variables du fichier \\de configuration du module \\principal \color{path}ColorsText.conf}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du fichier de configuration du module principal "ColorsText.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du fichier de configuration du module principal "ColorsText.conf")
  /Keywords ()
}
