...
\title{\color{sec1}Fonctions et variables du fichier \\de configuration du module \\principal \color{path}Locale.conf}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du fichier de configuration du module principal "Locale.conf")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du fichier de configuration du module principal "Locale.conf")
  /Keywords ()
}
