...
\pdfinfo{
  /Title    (Fonctions du fichier de librairie TextFormat.lib)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions du fichier de librairie TextFormat.lib)
  /Keywords ()
}
...
\begin{justify}
    Ce fichier source inclut des fonctions servant à la coloration du texte, du fond de l'espace occupé par un caractère, et à la mise en forme du texte dans différents formats :
    \begin{itemize}
      \item \textbf{gras},\mbox{}
      \item \textit{italique},\\\mbox{}
    \end{itemize}
