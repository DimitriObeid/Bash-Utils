...
\pagecolor{back}
\title{\color{sec1}Fonctions du fichier de librairie \color{path}Terminal.lib}\color{text}
...
\pdfinfo{
  /Title    (Fonctions du fichier de librairie Terminal.lib)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions du fichier de librairie Terminal.lib)
  /Keywords ()
}
...
Ce fichier source inclut des fonctions servant à la gestion de décorations spéciales pour le terminal, en respectant les normes POSIX associées, sans proposer de fonctionnalités ne pouvant s'exécuter sur quelques terminaux.\\[1\baselineskip]
