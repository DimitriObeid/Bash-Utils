...
\begin{justify}
    Ce fichier source inclut des fonctions servant de contrôleurs, servant elles-mêmes à contrôler l'exécution de fonctions via des vérifications :
    \begin{enumerate}
        \item de valeurs de \textbf{\color{vars}variables globales},

        \item de présence de \textbf{\color{path}dossiers} et de \textbf{\color{path}fichiers},

        \item de la valeur d'UID (\textbf{U}ser \textbf{ID}entifier)
    \end{enumerate}
\end{justify}
