...
\begin{justify}
    Chacune des variables globales de couleur de fond commençant par ce nom retourne le résultat de la fonction \textbf{\color{func}BU.Main.Colors.SetBGColor} lors de l'appel d'une de ces variables, pour colorer l'arrière plan du texte selon le code couleur.
\end{justify}
...
\begin{justify}
    Chacune des variables globales de couleur de texte commençant par ce nom retourne le résultat de la fonction \textbf{\color{func}BU.Main.Colors.SetTextColor} lors de l'appel d'une de ces variables, pour colorer le texte selon le code couleur.
\end{justify}
...
\begin{justify}
    \textbf{\color{cond}Si} une substitution de commande est passée au paramètre \textbf{\color{vars}p\_lineColor}, \textbf{\color{cond}alors} la fonction actuelle l'exécute. Cette substitution \textbf{DOIT} être un appel de la fonction \textbf{\color{func}BU.Main.Colors.SetTextColor}.
\end{justify}
