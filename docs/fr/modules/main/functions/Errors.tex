...
\begin{justify}
    Passer une valeur à ce paramètre est nécessaire dans les situations où l'appel des fonctions \textbf{\color{mauve}BU::Echo<...>()} peut provoquer une boucle infinie.
\end{justify}
