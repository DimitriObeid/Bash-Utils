...
\pagecolor{black}
\title{\color{red}Fonctions du fichier de librairie \color{lime}Text.lib}\color{white}
...
\pdfinfo{
  /Title    (Fonctions du fichier de librairie Text.lib)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions du fichier de librairie Text.lib)
  /Keywords ()
}
