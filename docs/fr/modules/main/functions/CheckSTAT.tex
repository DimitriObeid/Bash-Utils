...
\begin{flushleft}
	\textbf{Description de la fonction :}\\
   	...
   	\textbf{Paramètres :}
   	\begin{itemize}
        \item \color{orange}\textbf{\$p\_file\color{white} :} \color{white} fichier dans lequel cette fonction est appelée (de préférence avec la commande \textbf{"\$(\color{gray}basename \color{white}"\color{orange}\$BASH\_SOURCE[0]\color{white}")")}.\\[1\baselineskip]
