...
\pagecolor{black}
\title{\color{red}Fonctions du fichier de librairie \color{lime}CheckSTAT.lib}\color{white}
...
\textbf{Description de la fonction :}\\
Cette fonction vérifie que la valeur enregistrée dans la variable de statut \textbf{\color{orange}\$\_\_BU\_MAIN\_STAT\_DECHO} corresponde aux chaînes de caractères suivantes :\\[1\baselineskip]
...
\textbf{Description de la fonction :}\\
\begin{itemize}
    \item Cette fonction\\[1\baselineskip]
\end{itemize}
