...
\title{\color{sec1}Fonctions et variables du script \\d'initialisation du module \color{sec2}Software}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du script d'initialisation du module "Software")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du script d'initialisation du module "Software")
  /Keywords ()
}
