...
\title{\color{sec1}Fonctions et variables du script \\d'initialisation du module \color{sec2}Hardware}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du script d'initialisation du module "Hardware")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du script d'initialisation du module "Hardware")
  /Keywords ()
}
