...
% Title for hashing : "Bash-utils/docs/en/Tutorials.tex"
...
\title{\color{red}Tutorials for basic additions into the main module's code}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Tutorials for basic additions into the main module's code)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Tutorials for basic additions into the main module's code)
  /Keywords ()
}
