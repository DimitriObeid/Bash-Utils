...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/module-delete-file-by-OS.tex"
...
\pdfinfo{
  /Title    (Deciphering the mechanics behind the "module-delete-file-by-OS.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Deciphering the mechanics behind the "module-delete-file-by-OS.sh" script)
  /Keywords ()
}
