...
\usepackage[usenames,dvipsnames]{xcolor}                    % Text colouring.
...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/lib-compilerV4.tex"
...
\title{\color{sec1}Bash Utils framework compiler documentation and deciphering the mechanics behind the \\ \textbf{\color{sec2}lib-compilerV4.sh} script}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Bash Utils framework compiler documentation and deciphering the mechanics behind the "lib-compilerV4.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Bash Utils framework compiler documentation and deciphering the mechanics behind the "lib-compilerV4.sh" script)
  /Keywords ()
}
