...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/latex-create-file-arch-lang.tex"
...
\title{\color{sec1}Deciphering the mechanics behind the \\ \textbf{\color{sec2}latex-create-file-arch-lang.sh} script}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Deciphering the mechanics behind the "latex-create-file-arch-lang.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Deciphering the mechanics behind the "latex-create-file-arch-lang.sh" script)
  /Keywords ()
}
