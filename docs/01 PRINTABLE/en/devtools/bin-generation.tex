...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/bin-generation.tex"
...
\title{\color{sec1}Deciphering the mechanics behind the \\ \textbf{\color{sec2}bin-generation.sh} script}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Deciphering the mechanics behind the "bin-generation.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Deciphering the mechanics behind the "bin-generation.sh" script)
  /Keywords ()
}
