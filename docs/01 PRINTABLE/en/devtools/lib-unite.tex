...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/lib-unite.tex"
...
\pdfinfo{
  /Title    (Deciphering the mechanics behind the "lib-unite.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Deciphering the mechanics behind the "lib-unite.sh" script)
  /Keywords ()
}
