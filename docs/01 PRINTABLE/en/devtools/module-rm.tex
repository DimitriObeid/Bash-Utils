...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/devtools/module-rm.tex"
...
\title{\color{sec1}Deciphering the mechanics behind the \\ \textbf{\color{sec2}module-rm.sh} script}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Deciphering the mechanics behind the "module-rm.sh" script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Deciphering the mechanics behind the "module-rm.sh" script)
  /Keywords ()
}
