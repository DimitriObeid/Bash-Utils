...
% Title for hashing : "Bash-utils/docs/en/Color code.tex"
...
\title{\color{red}Color \color{orange}code \color{yellow}of \color{green}the \color{blue}official \color{violet}Bash \\\color{red}Utils \color{orange}framework \color{yellow}documentation}\color{text}
