...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/04) Functions/main/Headers.tex"
...
\pdfinfo{
  /Title    (Functions of the Headers.lib library file)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions of the Headers.lib library file)
  /Keywords ()
}
