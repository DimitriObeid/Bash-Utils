...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/04) Functions/main/Status.tex"
...
\title{\color{sec1}Functions of the \color{path}Status.lib\color{sec1} \ library file}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions of the Status.lib library file)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions of the Status.lib library file)
  /Keywords ()
}
