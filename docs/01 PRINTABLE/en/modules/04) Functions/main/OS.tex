...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/04) Functions/main/OS.tex"
...
\title{\color{sec1}Functions of the \color{path}OS.lib\color{sec1} \ library file}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions of the OS.lib library file)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions of the OS.lib library file)
  /Keywords ()
}
