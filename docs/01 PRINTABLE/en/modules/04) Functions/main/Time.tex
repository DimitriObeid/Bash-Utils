...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/04) Functions/main/Time.tex"
...
\title{\color{sec1}Functions of the \color{path}Time.lib\color{sec1} \ library file}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions of the Time.lib library file)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions of the Time.lib library file)
  /Keywords ()
}
