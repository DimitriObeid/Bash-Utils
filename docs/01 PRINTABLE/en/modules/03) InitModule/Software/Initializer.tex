...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/03) InitModule/Software/Sotware - Initializer.tex"
...
\title{\color{sec1}Functions and variables of the initialization \\script of the \color{sec2}Software\color{sec1}\ module}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions and variables of the initialization script of the "Software" module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the initialization script of the "Software" module)
  /Keywords ()
}
