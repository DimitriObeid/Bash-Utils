...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/03) InitModule/main/Main - Initializer.tex"
...
\pdfinfo{
  /Title    (Functions and variables of the main module's initializer script)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the main module's initializer script)
  /Keywords ()
}
