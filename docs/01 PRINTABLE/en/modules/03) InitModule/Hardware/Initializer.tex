...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/03) InitModule/Hardware/Hardware - Initializer.tex"
...
\pdfinfo{
  /Title    (Functions and variables of the initialization script of the "Hardware" module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the initialization script of the "Hardware" module)
  /Keywords ()
}
