...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/02) Config/main/Colors-conf.tex"
...
\title{\color{sec1}Functions and variables of the \color{path}Colors.conf\color{sec1}\\configuration file from the main module}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions and variables of the "Colors.conf" configuration file from the main module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the "Colors.conf" configuration file from the main module)
  /Keywords ()
}
