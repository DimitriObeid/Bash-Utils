...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/02) Config/main/Time-conf.tex"
...
\pdfinfo{
  /Title    (Functions and variables of the "Time.conf" configuration file from the main module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the "Time.conf" configuration file from the main module)
  /Keywords ()
}
