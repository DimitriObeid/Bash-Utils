...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/02) Config/main/Aliases-conf.tex"
...
\title{\color{sec1}Functions and variables of the \color{path}Aliases.conf\color{sec1}\\configuration file from the main module}\color{text}
\author{Dimitri OBEID}
\date{2023}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions and variables of the "Aliases.conf" configuration file from the main module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the "Aliases.conf" configuration file from the main module)
  /Keywords ()
}
