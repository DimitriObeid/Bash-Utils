...
% Title for hashing : "Bash-utils/docs/en/Functioning of the modules manager.tex"
...
\title{\color{red}Functioning of the modules manager}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functioning of the modules manager)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functioning of the modules manager)
  /Keywords ()
}
