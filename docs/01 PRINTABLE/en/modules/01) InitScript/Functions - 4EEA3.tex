...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/01) InitScript/Functions.tex"
...
\title{\color{sec1}Functions and variables of the initialization script \\of the modules of the Bash Utils framework}\color{text}
\author{Dimitri OBEID}
\date{2022}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions and variables of the initialization script of the modules of the Bash Utils framework)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the initialization script of the modules of the Bash Utils framework)
  /Keywords ()
}
