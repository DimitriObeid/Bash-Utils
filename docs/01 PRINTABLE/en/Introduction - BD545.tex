...
% Title for hashing : "Bash-utils/docs/en/Introduction to Bash Utils.tex"
...
\title{\color{red}Introduction to Bash Utils}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Introduction to Bash Utils)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Introduction to Bash Utils)
  /Keywords ()
}
