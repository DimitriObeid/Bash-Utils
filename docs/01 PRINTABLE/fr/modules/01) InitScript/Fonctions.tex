...
\title{\color{sec1}Fonctions et variables du script d'initialisation \\des modules du framework Bash Utils}\color{text}
\author{Dimitri OBEID}
\date{2022}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctions et variables du script d'initialisation des modules du framework Bash Utils)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctions et variables du script d'initialisation des modules du framework Bash Utils)
  /Keywords ()
}
