...
\title{\color{sec1}Codes d'erreurs du script d'initialisation \\des modules du framework Bash Utils}\color{text}
\author{Dimitri OBEID}
\date{2022}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Codes d'erreurs du script d'initialisation des modules du framework Bash Utils)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Codes d'erreurs du script d'initialisation des modules du framework Bash Utils)
  /Keywords ()
}
