...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}init-locale-file-rm.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "init-locale-file-rm.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "init-locale-file-rm.sh")
  /Keywords ()
}
