...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}latex-clean.sh.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "latex-clean.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "latex-clean.sh")
  /Keywords ()
}
