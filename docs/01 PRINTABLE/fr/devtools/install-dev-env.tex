...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}install-dev-env.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "install-dev-env.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "install-dev-env.sh")
  /Keywords ()
}
