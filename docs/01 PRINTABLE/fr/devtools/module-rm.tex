...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}module-rm.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "module-rm.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "module-rm.sh")
  /Keywords ()
}
