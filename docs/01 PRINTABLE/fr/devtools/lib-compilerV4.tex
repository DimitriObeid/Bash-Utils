...
\title{\color{sec1}Fonctionnement du compilateur du \\framework Bash Utils \textbf{\color{sec2}lib-compilerV4.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du compilateur du framework Bash Utils "lib-compilerV4.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du compilateur du framework Bash Utils "lib-compilerV4.sh")
  /Keywords ()
}
