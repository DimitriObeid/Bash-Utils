...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}latex-create-file-arch-lang.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "latex-create-file-arch-lang.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "latex-create-file-arch-lang.sh")
  /Keywords ()
}
