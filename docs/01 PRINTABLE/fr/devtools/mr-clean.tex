...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}mr-clean.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "mr-clean.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "mr-clean.sh")
  /Keywords ()
}
