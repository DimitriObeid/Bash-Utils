...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}bin-generation.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "bin-generation.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "bin-generation.sh")
  /Keywords ()
}
