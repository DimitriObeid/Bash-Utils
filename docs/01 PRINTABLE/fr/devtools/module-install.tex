...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}module-install.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "module-install.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "module-install.sh")
  /Keywords ()
}
