...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}init-locale-file-mk.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "init-locale-file-mk.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "init-locale-file-mk.sh")
  /Keywords ()
}
