...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}module-pack.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "module-pack.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "module-pack.sh")
  /Keywords ()
}
