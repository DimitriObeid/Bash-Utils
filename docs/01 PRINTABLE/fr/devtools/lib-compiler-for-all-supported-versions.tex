...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}lib-compiler-for-all-supported-versions.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "lib-compiler-for-all-supported-versions.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement du script "lib-compiler-for-all-supported-versions.sh")
  /Keywords ()
}
