...
\title{\color{sec1}Fonctionnement du script\\ \textbf{\color{sec2}latex-convert-to-printable.sh}}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Fonctionnement du script "latex-convert-to-printable.sh")
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Fonctionnement "latex-convert-to-printable.sh")
  /Keywords ()
}
