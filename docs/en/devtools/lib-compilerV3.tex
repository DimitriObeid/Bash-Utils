...
\title{\color{sec1}Bash Utils framework compiler documentation}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Bash Utils framework compiler documentation)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Bash Utils framework compiler documentation)
  /Keywords ()
}
