...
% Title for hashing (unused for this file) : "Bash-utils/docs/en/modules/02) Config/Software/Module-conf.tex"
...
\title{\color{sec1}Functions and variables of the \color{path}Module.conf\color{sec1}\\configuration file from the \color{sec2}Software\color{sec1}\ module}\color{text}
\author{Dimitri OBEID}
\pagestyle{fancy}

\pdfinfo{
  /Title    (Functions and variables of the "Module.conf" configuration file from the "Software" module)
  /Author   (Dimitri OBEID)
  /Creator  (Dimitri OBEID)
  /Producer (Dimitri OBEID)
  /Subject  (Functions and variables of the "Module.conf" configuration file from the "Software" module)
  /Keywords ()
}
