...
% Title for hashing : "Bash-utils/docs/en/modules/02) Config/main/Module-conf.tex"
...
\title{\color{sec1}Functions and variables of the \color{path}Module.conf\color{sec1}\\configuration file from the main module}\color{text}
