...
\definecolor{path}{HTML}{bfff00}        % Citron vert   - Color of the files and folders paths.
\definecolor{sec1}{HTML}{ff0000}        % Rouge         - Color of the main and first level titles.
\definecolor{sec2}{HTML}{00ff00}        % Vert          - Color of the second level titles.

\definecolor{sec3}{HTML}{0060ff}        % Bleu          - Color of the third level titles.
\definecolor{text}{HTML}{ffffff}        % Blanc | Noir  - Color of the normal text.
