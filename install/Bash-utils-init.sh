...
function BU.ModuleInit.IsFrameworkStableCompiled()      { ; }

#
#

function BU.ModuleInit.IsFrameworkUnstableCompiled()    { ; }
...
# Featured function(s) and file(s) by module(s) and from the "functions" folder :
#   - BU.ModuleInit.IsFrameworkLocalizedCompiled()      -> Modules initializer script (this file)
...
# thousands and thousands of lines of messages.
...
function BU.ModuleInit.PrintIsInScriptEnvironmentErrorMessage()
{
    ...
    [ "${v_userLang,,}" == 'de' ] && && v_isPrinted='true';
    [ "${v_userLang,,}" == 'en' ] && && v_isPrinted='true';
    [ "${v_userLang,,}" == 'es' ] && && v_isPrinted='true';

    [ "${v_userLang,,}" == 'fr' ] && && v_isPrinted='true';
    [ "${v_userLang,,}" == 'id' ] && && v_isPrinted='true';
    [ "${v_userLang,,}" == 'pt' ] && && v_isPrinted='true';

    [ "${v_userLang,,}" == 'ru' ] && && v_isPrinted='true';
    [ "${v_userLang,,}" == 'uk' ] && && v_isPrinted='true';
