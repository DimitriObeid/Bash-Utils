...
function BU.ModuleInit.IsFrameworkWrapped() { local v_currFile="$(basename "${BASH_SOURCE[0]}")"; if [ "$v_currFile" == "Bash-utils.sh" ] && [ "$(wc -l "$v_currFile" | cut -f1 -d" ")" -ge 19078 ]; then return 0; else return 1; fi }
